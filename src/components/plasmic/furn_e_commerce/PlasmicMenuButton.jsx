...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: pJaTTuLIzYklDL/css
import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: b_-juCRIBYi-1u/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: vFU6-iIi36JBNv/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__k4HxL, {
              [sty.svgexpanded__k4HxLlchs9]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__ecP5G, {
              [sty.svgexpanded__ecP5Glchs9]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
